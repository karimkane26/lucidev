...
const socialLinks = [
  ...
  {
    href: 'https://x.com/Abdoulk82109408?t=vu1EjUa2ddD6yMzjYfjJFw&s=08',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-900/10 dark:ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-900 hover:text-zinc-50 dark:hover:bg-zinc-50 dark:hover:text-zinc-950 active:scale-95 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/apjjewwa"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="email"
                required
                placeholder="abdoulkarim@gmail.com"
                autoComplete="email"
                className="text-field reveal-up"
              />
            </div>
            ...
            <button
              type="submit"
              className="btn btn-primary [&]:max-w-full w-full justify-center reveal-up md:col-span-2"
            >
              Submit
            </button>
          </div>
